...
#define REX_IMAGE_SIZE 0x2B50000ull
#define REX_CODE_BASE 0x82180000ull
#define REX_CODE_SIZE 0x7D2114ull
...
// Hooks the project itself provides. A [[midasm_hook]] names a function by
// string, and that function has to be declared somewhere the generated code
// can see -- without this there is nowhere to put it, and the whole hook
// mechanism is unusable outside the SDK. Optional: a project with no hooks
// ships no such header and the include disappears.
#if __has_include("legacyrecomp_hooks.h")
#include "legacyrecomp_hooks.h"
#endif
